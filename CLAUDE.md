...
- **Model per job.** Use **Sonnet 5 Max** for `bmad-dev-story` and any follow-up implementation (fix/feature) requests. Use **Opus High** for all other BMad jobs (planning: brief, PRD, architecture, epics/stories, UX, retrospectives, reviews).
