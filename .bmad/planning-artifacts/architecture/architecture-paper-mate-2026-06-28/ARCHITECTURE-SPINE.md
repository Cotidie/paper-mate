...
- **OCR / scanned PDFs** remains deferred. opendataloader's **hybrid mode** (Docling + a vision model), by contrast, is **adopted (Story 10.8, un-deferred 2026-07-21)** as a runtime-switchable extraction mode for higher structure fidelity; local mode stays the deterministic + offline default-able fallback (see AD-13).
