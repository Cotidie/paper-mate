...
- **OCR / scanned PDFs**, opendataloader's hybrid mode (Docling + a vision model) is deferred; AD-13's structure layer is born-digital, deterministic + offline for v-next.
