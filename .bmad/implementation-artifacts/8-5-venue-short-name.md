...
- **Version bump:** `server/pyproject.toml` `0.5.18` -> `0.5.19` (PATCH +1, story done). Not bumped again for the fix-request round (same story, not yet closed).
